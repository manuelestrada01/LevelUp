...
import type { BimestreConfigEntry } from "@/lib/supabase/config";
...
function emptyEntry(courseId: string, bimestre: string): BimestreConfigEntry {
  return { course_id: courseId, bimestre, start_date: "", end_date: "" };
}

export default function BimestreConfigEditor({ courseId, initialEntries }: Props) {
  ...
  function update(index: number, field: "start_date" | "end_date", value: string) {
