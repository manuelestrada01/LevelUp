      ...
      {talents.length === 0 ? (
        ...
        <div className="grid grid-cols-4 gap-4">
          {talents.map((talent) => (
            <div
              key={talent.id}
              className="flex flex-col gap-3 rounded-lg border border-[#1e3320] bg-[#0d1a0f]/40 p-4"
            >
              <div className="flex items-center gap-2">
                <span className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-lg bg-[#c9a227]/10 text-base leading-none">
